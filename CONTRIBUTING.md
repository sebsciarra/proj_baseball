...
Welcome to `proj_baseball` contributor's guide.
...
If you experience bugs or general issues with `proj_baseball`, please have a look
...
You can help improve `proj_baseball` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`proj_baseball` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `proj_baseball`'s files. While this mechanism can
...
```
conda create -n proj_baseball python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/proj_baseball.git
   cd proj_baseball
   ```
...
5. Install [pre-commit]:
   ...
   `proj_baseball` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/proj_baseball
[issue tracker]: https://github.com/<USERNAME>/proj_baseball/issues
